...
## Scripts
*   `extract_race_results.py`: Connects to the FastF1 API, downloads the race results for a specific event (e.g., 2023 Bahrain Grand Prix), and loads it into the `raw.race_results` table in our Postgres Data Warehouse.
